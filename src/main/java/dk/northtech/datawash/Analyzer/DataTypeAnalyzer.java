...
//    final ColumnAnalyzerContainer<ConcurrentColumnAnalyzer> columnAnalyzerContainer = new ColumnAnalyzerContainer<>();
...
//  }
  ...
  private void analyzeValue(final String columnId, @Nullable final Object value, final Map<String, ColumnAnalyzer>
    columnAnalyzers) {
    LOGGER.debug("Analyzing key: {}, value: {}", columnId, value);
